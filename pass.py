...
windows= Tk()
windows.title("generateur de mot de pass")
#windows.config(background='lightgray')
windows.geometry("1024x720")

"""
width=300
height=300
image = PhotoImage(file='marquer.svg')
...
for widgest in user_info_frame.winfo_children():
    widgest.grid_configure(padx=10, pady=5)
